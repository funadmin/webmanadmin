...
class  Member extends BaseModel{
    ...
    public function login(){
        ...
        if (strtolower($data['vercode']) !== request()->session()->get('captcha')) {
            throw new \Exception('verification_code_error');
        }
