<?php /*a:1:{s:71:"D:\wwwroot\my-space\funadmin-webadmin\app/backend/view/index\index.html";i:1657151612;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layui-hide-xs">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a lay-event="langset" title="<?php echo lang($vo['name']); ?>" data-ajax="<?php echo __u('ajax/enlang',['lang'=>$vo['name']]); ?>"><?php echo lang($vo['name']); ?></a></dd>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <!--                        <dd><a lay-event="langset" title="<?php echo lang('en-us'); ?>" lay-ajax="<?php echo __u('ajax/enlang',['langset'=>'en-us']); ?>">en-us</a></dd>-->
                    </dl>
                </li>
                <li class="layui-nav-item layui-hide-xs">
            ...
            <div class="layui-tab layui-tab-card" id="layui-tab"  overflow lay-allowclose="true" lay-filter="layui-layout-tabs">
                ...
                <div class="layui-body layui-tab-content" id="layui-app-body">
                    <div id="homePage" class="layui-body-tabs layui-tab-item layui-show">
                        <iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" src="<?php echo __u('index/console'); ?>"></iframe>
                    </div>
                </div>
            </div>
