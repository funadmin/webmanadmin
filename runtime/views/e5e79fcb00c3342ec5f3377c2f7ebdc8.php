<?php /*a:2:{s:79:"D:\wwwroot\my-space\funadmin-webadmin\app/backend/view/auth\admin\password.html";i:1657081166;s:71:"D:\wwwroot\my-space\funadmin-webadmin\app/backend/view/layout\main.html";i:1657019448;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<form class="layui-form">
    <?php if($id): ?>
        <?php echo form_input('oldpassword','password',['label'=>'NewPasswd','verify'=>'required|pass']); ?>
        <?php echo form_input('password','password',['label'=>'ReNewPasswd','verify'=>'required|pass']); else: ?>
        <?php echo form_input('oldpassword','password',['label'=>'oldpassword','verify'=>'required|pass']); ?>
        <?php echo form_input('password','password',['label'=>'NewPasswd','verify'=>'required|pass']); ?>
    <?php endif; if(request()->input('type')): ?>
    <?php echo form_submitbtn(true,['show'=>1]); else: ?>
