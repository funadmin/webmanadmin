<?php /*a:1:{s:69:"D:\wwwroot\my-space\funadmin-webadmin\app/index/view/index\index.html";i:1657151035;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    <title>FunAdmin - 基于webman,thinkorm,layui开发的敏捷通用的后台管理框架</title>
    <meta name="keywords" content="基于webman,FunAdmin,TP6后台管理系统,thinkorm通用后台,ThinkPHP框架,Layui后台,Thinkphp小程序,小程序,CMS,电商，微信,PHP插件应用市场,支持PHP8.0, ">
    <meta name="description"，
          content="FunAdmin支持PHP8.0的系统, 是一款采用 layui开发的敏捷的后台管理框架,基于基于webman,thinkorm ,easywechat,开发的cms后台管理系统,thinkphp,shop,cms,php后台管理系统,cms,cms系统,restful api,thinkphp后台管理系统">
    ...
    <div class="layui-header header header-index layui-bg-black" autumn>
        <div class="layui-main">
            ...
            <ul class="layui-nav">
                ...
                <!--                <li class="layui-nav-item ">-->
                <!--                    <a href="<?php echo url('member/index'); ?>" target="_blank" class="layui-tips">会员-->
    ...
    <div class="site-banner">
        ...
        <div class="site-banner-main">
            ...
            <div class="layui-anim site-desc site-desc-anim">
                ...
                <p class="web-font-desc layui-hide-xs" style="font-size: 16px;">框架主要使用thinkorm.X + layui + requirejs拥有完善的权限的管理模块以及插件的开发方式，让你开发起来更加简单。</p>
                <!--                <cite></cite>-->
            </div>
